...
class Spacecraft
{
    ...
    public:
        ...
        QQuaternion predictOrientation(const QDateTime &i_date);
        ...
        SpiceChar etSpacecraftJulian[100];


        //oriantation ind deg, deg/s
        DatedValueList *quatW;
        DatedValueList *quatX;
        DatedValueList *quatY;
        DatedValueList *quatZ;

        DatedValueList *angularRateX;
        DatedValueList *angularRateY;
        DatedValueList *angularRateZ;


        //generated by predicion routine
        ...
        DatedValueList predictionQuatW;
        DatedValueList predictionQuatX;
        DatedValueList predictionQuatY;
        DatedValueList predictionQuatZ;
