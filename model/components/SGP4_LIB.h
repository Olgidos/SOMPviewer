...
//includes of sgp4-library by Daniel Warner
#include <libs/sgp4-master/libsgp4/CoordTopocentric.h>
#include <libs/sgp4-master/libsgp4/CoordGeodetic.h>
#include <libs/sgp4-master/libsgp4/Observer.h>
#include <libs/sgp4-master/libsgp4/SGP4.h>
#include <libs/sgp4-master/libsgp4/Util.h>
...
/*!
 * \brief The SGP4_lib class
 * This header provides all required functions to use Daniel Warner SGP4-integration
 * https://github.com/dnwrnr/sgp4
 * Code based on his provided Examples "passpredict", "sattrack"
 */
class SGP4_lib
{
public:
    static double FindMaxElevation(
    ...
    static DateTime FindCrossingPoint(
            const CoordGeodetic& user_geo,
            SGP4& sgp4,
    ...
    static std::list<PassDetails> GeneratePassList(
            const CoordGeodetic& user_geo,
            SGP4& sgp4,
...
/*!
 * \brief The SpacecrafData wrapper class
 */
class SpacecrafData
{
public:
    ...
    /*!
     * \brief SpacecrafData to provide data
     * \param i_dt DateTime
     * \param i_eci Eci
     * \param i_topo CoordTopocentric
     * \param i_geo CoordGeodetic
     */
    SpacecrafData(DateTime i_dt, Eci i_eci, CoordTopocentric i_topo, CoordGeodetic i_geo)
        :
          dt(i_dt),
          eci(i_eci),
          topo(i_topo),
    ...
    /*!
     * \brief toString
     * \return Sting DateTime + CoordTopocentric + CoordGeodetic
     */
    std::string toString() {
        std::string s = dt.ToString();
        s.append(" ");
        s.append(topo.ToString());
        s.append(" ");
        s.append(geo.ToString());
        return s;
    }
};
